...
func TestSizer(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			sizer := &Sizer{Width: tt.terminalWidth, Height: tt.terminalHeight}
			if sizer == nil {
				t.Fatal("Sizer creation failed")
			}
...
func TestSizerCalculations(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			sizer := &Sizer{Width: tt.width, Height: tt.height}
...
func TestSizerDynamicCalculations(t *testing.T) {
	sizer := &Sizer{Width: 100, Height: 30}
	...
	t.Run("adaptive_sizing", func(t *testing.T) {
		...
		for _, size := range sizes {
			s := &Sizer{Width: size.width, Height: size.height}
...
func TestSizerEdgeCases(t *testing.T) {
	...
	t.Run("negative_dimensions", func(t *testing.T) {
		sizer := &Sizer{Width: -10, Height: -10}
	...
	t.Run("extreme_dimensions", func(t *testing.T) {
		...
		sizer := &Sizer{Width: 10000, Height: 10000}
		...
		sizer2 := &Sizer{Width: 20, Height: 10000}
